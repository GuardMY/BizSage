...
public class UserStore {
  ...
  private final List<UserAccount> users = List.of(
      new UserAccount(1, "admin", "password", Role.SUPER_ADMIN, "13812345678", "110101199003071234", "cn-default", "general"),
      new UserAccount(2, "operator", "password", Role.OPERATOR, "13912345678", "110101199003071235", "cn-default", "general"),
      new UserAccount(3, "user", "password", Role.USER, "13712345678", "110101199003071236", "cn-default", "general"));
