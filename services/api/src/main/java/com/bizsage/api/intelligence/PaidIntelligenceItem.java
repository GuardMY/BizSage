...
@TableName("paid_intelligence")
public class PaidIntelligenceItem {
  ...
  public PaidIntelligenceItem() {
  }

  public PaidIntelligenceItem(Long id, String title, String content, String url, String status,
